...
public class XMachineParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XMachineGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMachineAccess().getVariablesAssignment_5_1(), "rule__Machine__VariablesAssignment_5_1");
			builder.put(grammarAccess.getMachineAccess().getInvariantsAssignment_6_1(), "rule__Machine__InvariantsAssignment_6_1");
			builder.put(grammarAccess.getMachineAccess().getVariantsAssignment_7_1(), "rule__Machine__VariantsAssignment_7_1");
			builder.put(grammarAccess.getMachineAccess().getEventsAssignment_8_1(), "rule__Machine__EventsAssignment_8_1");
