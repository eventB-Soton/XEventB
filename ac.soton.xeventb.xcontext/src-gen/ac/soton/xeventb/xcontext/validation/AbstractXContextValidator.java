...
public abstract class AbstractXContextValidator extends AbstractDeclarativeValidator {
	...
	protected List<EPackage> getEPackages() {
		...
		result.add(EPackage.Registry.INSTANCE.getEPackage("http://emf.eventb.org/models/core/context/2022"));
		result.add(EPackage.Registry.INSTANCE.getEPackage("http://soton.ac.uk/models/eventb/coreextension/2014"));
		result.add(EPackage.Registry.INSTANCE.getEPackage("http://soton.ac.uk/models/eventb/record/2022"));
		return result;
	}
}
