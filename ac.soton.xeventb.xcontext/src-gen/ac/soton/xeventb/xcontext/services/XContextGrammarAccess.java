...
public class XContextGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class XContextElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cAxiomsXAxiomParserRuleCall_6_1_0 = (RuleCall)cAxiomsAssignment_6_1.eContents().get(0);
		...
		//sets+=XCarrierSet+)? ('constants' constants+=XConstant+)? ('axioms' axioms+=XAxiom+)? 'end'
		...
		//XAxiom
		public RuleCall getAxiomsXAxiomParserRuleCall_6_1_0() { return cAxiomsXAxiomParserRuleCall_6_1_0; }
