 ...
 * @generated
 */
public class FeatureinclusionAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static FeatureinclusionPackage modelPackage;
	 ...
	 * @generated
	 */
	public FeatureinclusionAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = FeatureinclusionPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected FeatureinclusionSwitch<Adapter> modelSwitch =
		new FeatureinclusionSwitch<Adapter>() {
			@Override
			public Adapter caseMachineInclusion(MachineInclusion object) {
				return createMachineInclusionAdapter();
			}
			@Override
			public Adapter caseEventSynchronisation(EventSynchronisation object) {
				return createEventSynchronisationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ac.soton.eventb.featureinclusion.MachineInclusion <em>Machine Inclusion</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMachineInclusionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ac.soton.eventb.featureinclusion.EventSynchronisation <em>Event Synchronisation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEventSynchronisationAdapter() {
		return null;
	}
...
} //FeatureinclusionAdapterFactory
