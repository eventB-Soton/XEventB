...
public class XMachineGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MachineElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cVariablesXVariableParserRuleCall_5_1_0 = (RuleCall)cVariablesAssignment_5_1.eContents().get(0);
		private final Group cGroup_6 = (Group)cGroup.eContents().get(6);
		private final Keyword cInvariantsKeyword_6_0 = (Keyword)cGroup_6.eContents().get(0);
		private final Assignment cInvariantsAssignment_6_1 = (Assignment)cGroup_6.eContents().get(1);
		private final RuleCall cInvariantsXInvariantParserRuleCall_6_1_0 = (RuleCall)cInvariantsAssignment_6_1.eContents().get(0);
		private final Group cGroup_7 = (Group)cGroup.eContents().get(7);
		private final Keyword cVariantsKeyword_7_0 = (Keyword)cGroup_7.eContents().get(0);
		private final Assignment cVariantsAssignment_7_1 = (Assignment)cGroup_7.eContents().get(1);
		private final RuleCall cVariantsXVariantParserRuleCall_7_1_0 = (RuleCall)cVariantsAssignment_7_1.eContents().get(0);
		...
		private final RuleCall cEventsXEventParserRuleCall_8_1_0 = (RuleCall)cEventsAssignment_8_1.eContents().get(0);
		...
		//	sees+=[econtext::Context]+)?) ('variables' variables+=XVariable+)? ('invariants' invariants+=XInvariant+)? ('variants'
		//	variants+=XVariant+)? ('events' events+=XEvent+)?
		//	'end';
		...
		//('invariants' invariants+=XInvariant+)? ('variants' variants+=XVariant+)? ('events' events+=XEvent+)? 'end'
		...
		//XVariable
		public RuleCall getVariablesXVariableParserRuleCall_5_1_0() { return cVariablesXVariableParserRuleCall_5_1_0; }
		
		//('invariants' invariants+=XInvariant+)?
		public Group getGroup_6() { return cGroup_6; }
		
		//'invariants'
		public Keyword getInvariantsKeyword_6_0() { return cInvariantsKeyword_6_0; }
		
		//invariants+=XInvariant+
		public Assignment getInvariantsAssignment_6_1() { return cInvariantsAssignment_6_1; }
		
		//XInvariant
		public RuleCall getInvariantsXInvariantParserRuleCall_6_1_0() { return cInvariantsXInvariantParserRuleCall_6_1_0; }
		
		//('variants' variants+=XVariant+)?
		public Group getGroup_7() { return cGroup_7; }
		
		//'variants'
		public Keyword getVariantsKeyword_7_0() { return cVariantsKeyword_7_0; }
		
		//variants+=XVariant+
		public Assignment getVariantsAssignment_7_1() { return cVariantsAssignment_7_1; }
		
		//XVariant
		public RuleCall getVariantsXVariantParserRuleCall_7_1_0() { return cVariantsXVariantParserRuleCall_7_1_0; }
		...
		//XEvent
		public RuleCall getEventsXEventParserRuleCall_8_1_0() { return cEventsXEventParserRuleCall_8_1_0; }
