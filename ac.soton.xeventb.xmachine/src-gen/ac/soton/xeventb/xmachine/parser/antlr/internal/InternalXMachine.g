...
// Entry rule entryRuleXMultipleVariable
entryRuleXMultipleVariable returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXMultipleVariableRule()); }
	iv_ruleXMultipleVariable=ruleXMultipleVariable
	{ $current=$iv_ruleXMultipleVariable.current; }
	EOF;

// Rule XMultipleVariable
ruleXMultipleVariable returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleXIndividualVariable returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXIndividualVariableRule()); }
	iv_ruleXIndividualVariable=ruleXIndividualVariable
	{ $current=$iv_ruleXIndividualVariable.current; }
	EOF;

// Rule XIndividualVariable
ruleXIndividualVariable returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleXMultipleInvariant
entryRuleXMultipleInvariant returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXMultipleInvariantRule()); }
	iv_ruleXMultipleInvariant=ruleXMultipleInvariant
	{ $current=$iv_ruleXMultipleInvariant.current; }
	EOF;

// Rule XMultipleInvariant
ruleXMultipleInvariant returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleXIndividualInvariant returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXIndividualInvariantRule()); }
	iv_ruleXIndividualInvariant=ruleXIndividualInvariant
	{ $current=$iv_ruleXIndividualInvariant.current; }
	EOF;

// Rule XIndividualInvariant
ruleXIndividualInvariant returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleXConstraint returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXConstraintRule()); }
	iv_ruleXConstraint=ruleXConstraint
	{ $current=$iv_ruleXConstraint.current; }
	EOF;

// Rule XConstraint
ruleXConstraint returns [EObject current=null]
@init {
	enterRule();
}
@after {
