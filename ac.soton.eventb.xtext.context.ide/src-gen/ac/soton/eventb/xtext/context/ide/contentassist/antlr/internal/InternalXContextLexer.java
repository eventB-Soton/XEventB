...
public class InternalXContextLexer extends Lexer {
    ...
    public final void mRULE_XLABEL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXContext.g:2197:13: ( '@' (~ ( ':' ) )+ ':' )
            // InternalXContext.g:2197:15: '@' (~ ( ':' ) )+ ':'
            {
            match('@'); 
            // InternalXContext.g:2197:19: (~ ( ':' ) )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXContext.g:2199:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalXContext.g:2199:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalXContext.g:2199:11: ( '^' )?
            int alt2=2;
            ...
            // InternalXContext.g:2199:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXContext.g:2201:10: ( ( '0' .. '9' )+ )
            // InternalXContext.g:2201:12: ( '0' .. '9' )+
            {
            // InternalXContext.g:2201:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalXContext.g:2201:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXContext.g:2203:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalXContext.g:2203:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalXContext.g:2203:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalXContext.g:2203:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalXContext.g:2203:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXContext.g:2205:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalXContext.g:2205:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalXContext.g:2205:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXContext.g:2207:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalXContext.g:2207:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalXContext.g:2207:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXContext.g:2209:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalXContext.g:2209:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalXContext.g:2209:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXContext.g:2211:16: ( . )
            // InternalXContext.g:2211:18: .
            {
            matchAny(); 
    ...
    static final String DFA13_eotS =
        "\1\uffff\5\20\2\16\2\uffff\3\16\2\uffff\1\20\1\uffff\5\20\6\uffff\1\20\1\44\6\20\1\uffff\1\20\1\54\5\20\1\uffff\5\20\1\67\1\20\1\71\1\20\1\73\1\uffff\1\74\1\uffff\1\20\2\uffff\1\76\1\uffff";
    static final String DFA13_eofS =
        "\77\uffff";
    static final String DFA13_minS =
        "\1\0\1\157\1\156\1\145\1\170\1\150\1\0\1\101\2\uffff\2\0\1\52\2\uffff\1\156\1\uffff\1\144\2\164\1\151\1\145\6\uffff\1\163\1\60\1\145\1\163\2\157\1\145\1\164\1\uffff\1\156\1\60\1\155\1\162\1\170\1\141\1\144\1\uffff\1\163\1\145\1\164\1\156\1\163\1\60\1\155\1\60\1\164\1\60\1\uffff\1\60\1\uffff\1\163\2\uffff\1\60\1\uffff";
    static final String DFA13_maxS =
        "\1\uffff\1\157\1\170\1\145\1\170\1\150\1\uffff\1\172\2\uffff\2\uffff\1\57\2\uffff\1\156\1\uffff\1\144\2\164\1\151\1\145\6\uffff\1\164\1\172\1\145\1\163\2\157\1\145\1\164\1\uffff\1\156\1\172\1\155\1\162\1\170\1\141\1\144\1\uffff\1\163\1\145\1\164\1\156\1\163\1\172\1\155\1\172\1\164\1\172\1\uffff\1\172\1\uffff\1\163\2\uffff\1\172\1\uffff";
    static final String DFA13_acceptS =
        "\10\uffff\1\11\1\12\3\uffff\1\16\1\17\1\uffff\1\11\5\uffff\1\10\1\12\1\13\1\14\1\15\1\16\10\uffff\1\2\7\uffff\1\4\12\uffff\1\6\1\uffff\1\1\1\uffff\1\3\1\7\1\uffff\1\5";
    static final String DFA13_specialS =
        "\1\1\5\uffff\1\3\3\uffff\1\0\1\2\63\uffff}>";
