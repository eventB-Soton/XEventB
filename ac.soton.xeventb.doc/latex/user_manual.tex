...
\ifplastex
\newcommand{\XEventBManualDate}{August 21st, 2017}
\else
\usepackage{datetime}
\newdate{XEventBManualDate}{21}{8}{2017}
\fi
\newcommand{\XEventBFeatureVersion}{0.0.7}
\newcommand{\XEventBManualVersion}{0.0.3}
