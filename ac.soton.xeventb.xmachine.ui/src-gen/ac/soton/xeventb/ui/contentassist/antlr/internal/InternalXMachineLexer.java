package ac.soton.xeventb.ui.contentassist.antlr.internal;
...
public class InternalXMachineLexer extends Lexer {
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:24:7: ( 'begin' )
            // InternalXMachine.g:24:9: 'begin'
            {
            match("begin"); 
    ...
    public final void mT__32() throws RecognitionException {
        try {
            int _type = T__32;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:31:7: ( 'includes' )
            // InternalXMachine.g:31:9: 'includes'
            {
            match("includes"); 
    ...
    public final void mT__33() throws RecognitionException {
        try {
            int _type = T__33;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:32:7: ( 'theorem' )
            // InternalXMachine.g:32:9: 'theorem'
            {
            match("theorem"); 
    ...
    public final void mT__34() throws RecognitionException {
        try {
            int _type = T__34;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:33:7: ( 'extended' )
            // InternalXMachine.g:33:9: 'extended'
            {
            match("extended"); 
    ...
    public final void mRULE_XLABEL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:10501:13: ( '@' (~ ( ':' ) )+ ':' )
            // InternalXMachine.g:10501:15: '@' (~ ( ':' ) )+ ':'
            {
            match('@'); 
            // InternalXMachine.g:10501:19: (~ ( ':' ) )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:10503:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalXMachine.g:10503:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalXMachine.g:10503:11: ( '^' )?
            int alt2=2;
            ...
            // InternalXMachine.g:10503:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:10505:10: ( ( '0' .. '9' )+ )
            // InternalXMachine.g:10505:12: ( '0' .. '9' )+
            {
            // InternalXMachine.g:10505:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalXMachine.g:10505:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:10507:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalXMachine.g:10507:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalXMachine.g:10507:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalXMachine.g:10507:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalXMachine.g:10507:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                    ...
                    break;
                case 2 :
                    // InternalXMachine.g:10507:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalXMachine.g:10507:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:10509:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalXMachine.g:10509:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalXMachine.g:10509:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:10511:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalXMachine.g:10511:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalXMachine.g:10511:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:10513:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalXMachine.g:10513:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalXMachine.g:10513:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXMachine.g:10515:16: ( . )
            // InternalXMachine.g:10515:18: .
            {
            matchAny(); 
    ...
    static final String DFA13_eotS =
        "\1\uffff\14\30\1\uffff\2\26\2\uffff\3\26\2\uffff\1\30\1\uffff\2\30\1\65\11\30\1\100\4\30\7\uffff\3\30\1\110\1\uffff\1\30\1\112\10\30\1\uffff\7\30\1\uffff\1\30\1\uffff\3\30\1\140\4\30\1\145\2\30\1\150\1\151\10\30\1\uffff\4\30\1\uffff\1\30\1\170\2\uffff\1\171\4\30\1\176\10\30\2\uffff\3\30\1\u008a\1\uffff\1\30\1\u008c\2\30\1\u008f\2\30\1\u0092\1\u0093\2\30\1\uffff\1\u0096\1\uffff\2\30\1\uffff\1\30\1\u009a\2\uffff\2\30\1\uffff\1\30\1\u009e\1\30\1\uffff\1\u00a0\2\30\1\uffff\1\u00a3\1\uffff\1\u00a4\1\30\2\uffff\1\u00a6\1\uffff";
    static final String DFA13_eofS =
        "\u00a7\uffff";
    static final String DFA13_minS =
        "\1\0\1\162\1\157\1\156\1\141\1\156\2\145\1\141\1\156\1\150\1\145\1\150\1\uffff\1\0\1\101\2\uffff\2\0\1\52\2\uffff\1\144\1\uffff\1\156\1\164\1\60\1\143\1\144\1\145\1\164\1\146\1\145\1\156\1\162\1\143\1\60\1\145\1\147\1\164\1\145\7\uffff\1\151\1\166\1\151\1\60\1\uffff\1\150\1\60\1\156\1\145\1\151\1\163\1\143\1\151\1\141\1\154\1\uffff\1\156\1\151\1\150\2\156\1\145\1\143\1\uffff\1\151\1\uffff\1\164\2\156\1\60\1\150\1\141\1\162\1\165\1\60\1\162\1\156\2\60\1\145\1\141\1\162\1\151\1\156\1\163\1\144\1\145\1\uffff\1\162\1\142\1\151\1\144\1\uffff\1\145\1\60\2\uffff\1\60\1\162\1\147\1\160\1\145\1\60\1\145\1\163\1\157\1\154\1\164\1\141\1\145\1\155\2\uffff\1\171\1\145\1\141\1\60\1\uffff\1\144\1\60\1\156\1\145\1\60\1\156\1\163\2\60\1\156\1\164\1\uffff\1\60\1\uffff\1\151\1\163\1\uffff\1\164\1\60\2\uffff\1\164\1\145\1\uffff\1\163\1\60\1\163\1\uffff\1\60\1\144\1\145\1\uffff\1\60\1\uffff\1\60\1\163\2\uffff\1\60\1\uffff";
    static final String DFA13_maxS =
        "\1\uffff\1\162\1\157\1\163\1\141\1\170\1\145\1\171\1\141\1\156\1\157\1\145\1\151\1\uffff\1\uffff\1\172\2\uffff\2\uffff\1\57\2\uffff\1\144\1\uffff\1\156\1\171\1\172\1\143\1\144\1\145\1\164\1\146\1\145\1\156\1\162\1\166\1\172\1\145\1\147\1\164\1\145\7\uffff\1\151\1\166\1\151\1\172\1\uffff\1\150\1\172\1\156\1\145\1\151\1\163\1\143\1\151\1\141\1\154\1\uffff\1\157\1\151\1\150\1\162\1\156\1\145\1\143\1\uffff\1\151\1\uffff\1\164\2\156\1\172\1\150\1\141\1\162\1\165\1\172\1\162\1\156\2\172\1\145\1\141\1\162\1\151\1\156\1\163\1\144\1\145\1\uffff\1\162\1\156\1\151\1\144\1\uffff\1\145\1\172\2\uffff\1\172\1\162\1\147\1\160\1\145\1\172\1\145\1\163\1\157\1\154\1\164\1\141\1\145\1\155\2\uffff\1\171\1\145\1\141\1\172\1\uffff\1\144\1\172\1\156\1\145\1\172\1\156\1\163\2\172\1\156\1\164\1\uffff\1\172\1\uffff\1\151\1\163\1\uffff\1\164\1\172\2\uffff\1\164\1\145\1\uffff\1\163\1\172\1\163\1\uffff\1\172\1\144\1\145\1\uffff\1\172\1\uffff\1\172\1\163\2\uffff\1\172\1\uffff";
    static final String DFA13_acceptS =
        "\15\uffff\1\24\2\uffff\1\32\1\33\3\uffff\1\37\1\40\1\uffff\1\32\21\uffff\1\24\1\31\1\33\1\34\1\35\1\36\1\37\4\uffff\1\15\12\uffff\1\14\7\uffff\1\22\1\uffff\1\5\25\uffff\1\7\4\uffff\1\21\2\uffff\1\17\1\20\16\uffff\1\16\1\23\4\uffff\1\13\13\uffff\1\4\1\uffff\1\6\2\uffff\1\12\2\uffff\1\26\1\1\2\uffff\1\27\3\uffff\1\25\3\uffff\1\10\1\uffff\1\2\2\uffff\1\11\1\3\1\uffff\1\30";
    static final String DFA13_specialS =
        "\1\3\15\uffff\1\2\3\uffff\1\1\1\0\u0093\uffff}>";
    static final String[] DFA13_transitionS = {
            "\11\26\2\25\2\26\1\25\22\26\1\25\1\26\1\22\4\26\1\23\6\26\1\15\1\24\12\21\6\26\1\16\32\20\3\26\1\17\1\20\1\26\1\3\1\13\1\2\1\20\1\5\3\20\1\11\3\20\1\4\1\20\1\1\2\20\1\6\1\7\1\12\1\20\1\10\1\14\3\20\uff85\26",
            "\1\27",
            "\1\31",
            "\1\32\4\uffff\1\33",
            "\1\34",
